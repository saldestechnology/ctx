...
# ctx:checksum sha256:adfc170f70f4e99fab816dd4c04929bedf394f9b3390c3f882d83fb4c5093b5f
...
if [ "$compat_status" -eq 3 ]; then
    echo "ctx hooks: installed ctx is older than these hook templates (need 0.3.5); skipping post-tool-use action. Update ctx, then rerun 'ctx harness init'." >&2
    exit 0
