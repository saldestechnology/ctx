...
# ctx:checksum sha256:4655e629aa0f35803de7bdfb3f5cae9ad003a0c52522ab2a094b73f773cccc80
...
if [ "$compat_status" -eq 3 ]; then
    echo "ctx hooks: installed ctx is older than these hook templates (need 0.3.5); skipping stop action. Update ctx, then rerun 'ctx harness init'." >&2
    exit 0
