...
# ctx:checksum sha256:8dbdbfc6414d30bb47d385480f5de0d4aa62cb842c04cc618697919d63d4f701
set -u
ctx harness compat --require "0.3.5" >/dev/null 2>&1 || { cat >/dev/null 2>&1 || true; exit 0; }
